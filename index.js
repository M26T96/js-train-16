...
function compareArrays(arr1, arr2) {
  arr1.sort();
  arr2.sort();
  let arrJson1 = JSON.stringify(arr1);
  let arrJson2 = JSON.stringify(arr2);
  console.assert(arrJson1 === arrJson2, 'Масиви не однакові')
